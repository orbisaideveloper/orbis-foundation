    ...
    <AppLayout>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-[var(--spacing-widget)]">
        ...
        <GlassCard
          ...
          delay={0.3}
          rawData={dashboardData.grid.runtimeSnapshot}
        >
