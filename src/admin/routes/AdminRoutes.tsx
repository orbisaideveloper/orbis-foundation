...
const EngineMonitorView = lazy(() =>
  Promise.resolve({
    default: () => (
      <div className="p-6 text-white">Engine Monitor Pipeline</div>
    ),
  }),
);
const BrainMonitorView = lazy(() =>
  Promise.resolve({
    default: () => (
      <div className="p-6 text-white">Brain AI Provider Pipeline</div>
    ),
  }),
);
