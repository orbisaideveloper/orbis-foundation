...
const ComingSoonBadge: any =
  (ComingSoonModule as any).default ||
  (ComingSoonModule as any).ComingSoonBadge ||
  (() => <div>Soon</div>);
const StatCard: any =
  (StatCardModule as any).default ||
  (StatCardModule as any).StatCard ||
  (() => <div>Stat</div>);
