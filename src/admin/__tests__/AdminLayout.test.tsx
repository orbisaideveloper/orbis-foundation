...
describe('AdminLayout Accessibility and Structure', () => {
  it('renders the Protected Admin Control Center landmark', () => {
    ...
    const appContainer = screen.getByRole('application', { name: /Protected Admin Control Center/i });
    ...
    const sidebar = screen.getByRole('complementary', { name: /Admin Navigation/i });
