    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-gray-800 border border-gray-700 p-6 rounded-lg">
          <h3 className="text-gray-400 text-sm font-medium uppercase mb-4">
            Current Public Version
          </h3>
          <div className="space-y-3 font-mono text-sm text-gray-300">
            <p>
              Version ID: <span className="text-white">--</span>
            </p>
            <p>
              Publish Date: <span className="text-white">--</span>
            </p>
            <p>
              Stable Status: <span className="text-white">--</span>
            </p>
          </div>
        </div>
        ...
        <div className="bg-blue-950/30 border border-blue-900 p-6 rounded-lg">
          <h3 className="text-blue-400 text-sm font-medium uppercase mb-4">
            Candidate Version (Pending Approval)
          </h3>
          <div className="space-y-3 font-mono text-sm text-gray-300">
            <p>
              Candidate ID: <span className="text-white">--</span>
            </p>
            <p>
              SonarCloud Gate: <span className="text-white">--</span>
            </p>
            <p>
              Approval Status: <span className="text-white">--</span>
            </p>
          </div>
          <div className="mt-6">
      ...
      <div className="bg-gray-800 border border-gray-700 p-6 rounded-lg mt-6">
        ...
        <p className="text-sm text-gray-500 italic">
          No release data loaded. Awaiting integration with EventBus.
        </p>
      </div>
    </div>
  );
