            ...
            {!selectedVersion ? (
                <div className="flex flex-col h-full">
                    ...
                    {loading ? (
                        ...
                        <div className="space-y-2.5 overflow-y-auto pr-1 custom-scrollbar flex-1 max-h-[55vh]">
                ...
                <div className="flex flex-col h-full">
                    <div className="flex flex-col sm:flex-row justify-between sm:items-center gap-3 mb-3 bg-slate-900 p-3 rounded-lg border border-slate-800">
                        ...
                        <div className="text-[12px] font-mono text-yellow-400 truncate max-w-[200px]">
